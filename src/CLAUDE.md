...
| `styles/global.css` | Hacker-Retro theme (bg `#111`, monospace, accent `rgba(0,255,26,0.5)`) | cavekit-site-shell.md R4 |
...
- Theme accent `rgba(0,255,26,0.5)` applies to all `<a>` by default; hover/active lifts to `0.9` alpha.
